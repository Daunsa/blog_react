...
function Post(props) {
    ...
    return (
        <>
            <div>
                <div className={`fixed top-0 left-0 w-full h-full bg-black opacity-50 z-10 ${showImage ? 'visible' : 'invisible'}`} onClick={toggleImage}></div>
                <div className={`fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-100 shadow-lg rounded-lg p-4 z-20 max-w-screen-md w-full ${showImage ? 'visible' : 'invisible'}`}>
                    <div className="">
                        <img src={image} alt="fingerprint recognition" className="lg:w-full w-auto" />
                        <div className="mt-4">
                        ...
                        <div onClick={cerrarImagen} className="absolute -top-2 -right-2 bg-gray-100 hover:bg-white h-10 w-10 rounded-full flex justify-center items-center ">
                            <svg onClick={cerrarImagen} width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path onClick={cerrarImagen} d="M16 8L8 16M8.00001 8L16 16M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-gray-50 p-4 ">
                ...
                >
                    <div className="text-center flex justify-center">
                        <img alt="" src="https://i.imgur.com/VecfPg8.jpg" onClick={abrirImagen} />
                    </div>
                    <div className="text-center flex justify-center">
                        <img alt="" src="https://i.imgur.com/73x7Cnu.jpg" onClick={abrirImagen} />
                    </div>
                    <div className="text-center flex justify-center">
                        <img alt="" src="https://i.imgur.com/VecfPg8.jpg" onClick={abrirImagen} />
                    </div>
                    <div className="text-center flex justify-center">
                        <img alt="" src="https://i.imgur.com/qCx0LTO.jpeg" onClick={abrirImagen} />
                    </div>
                </Carousel>

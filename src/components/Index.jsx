...
function Index() {
  ...
  const abrirPublicacion = () => {
    window.open("https://www.instagram.com/p/Cegs99dL7xu/?hl=es", "_blank");
  };
    ...
    <>
      <div id="content">
          ...
          <div className="2xl:px-20 lg:px-12 px-4 flex flex-wrap items-start mt-4">
            <div className="mt-24">
              <div className="flex items-end">
                <div onClick={abrirPublicacion} className="relative group rounded-lg mr-6">
                  <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/kBgtHK6/Rectangle-5.png" alt="girl with blue background" className="w-20 h-20" />
                  {instagram}
                </div>
                <div onClick={abrirPublicacion} className="relative group rounded-lg">
                  <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/9nLBtjx/Rectangle-3.png" alt="guy winking" className="w-48 h-36" />
                  {instagram}
                </div>
              </div>
              <div className="flex items-center justify-end my-6">
                <div onClick={abrirPublicacion} className="relative group">
                  <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/jRbF1KF/Rectangle-4.png" alt="guy smiling" />
                  {instagram}
                </div>
              </div>
              <div className="flex items-start rounded-lg">
                <div onClick={abrirPublicacion} className="relative group">
                  <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/Sf4Q94L/Rectangle-6.png" alt="girl with bluw background" className="w-48 h-48" />
                  {instagram}
                </div>
                <div onClick={abrirPublicacion} className="relative group rounded-lg ml-6 flex-shrink-0 object-cover object-fit">
                  <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/fnNqJrx/Rectangle-7.png" alt="guy with glasses" className="w-20 h-20" />
                  {instagram}
                </div>
              </div>
            </div>
            <div className="ml-6 mt-32 rounded-lg">
              <div onClick={abrirPublicacion} className="relative group mr-2">
                <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/LSxy7fy/Rectangle-9.png" className="w-72 h-80" alt="guy with sunglasses" />
                {instagram}
              </div>
              <div className="flex items-start mt-6">
                <div onClick={abrirPublicacion} className="relative group rounded-lg">
                  <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/X8PKD3q/Rectangle-8.png" alt="girl  laughing" className="w-48 h-48" />
                  {instagram}
                </div>
                <div onClick={abrirPublicacion} className="relative group rounded-lg ml-6 object-cover object-fit">
                  <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/2Yj51CY/Rectangle-13.png" alt="guy with glasses" className="w-20 h-20" />
                  {instagram}
                </div>
              </div>
            </div>
            <div className="mt-14 ml-6">
              <div className="lg:flex ">
                <div>
                  <div onClick={abrirPublicacion} className="relative group rounded-lg object-center object-fit">
                    <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/bWGVSkP/Rectangle-10.png" alt="group of friends" className="w-96 h-72" />
                    {instagram}
                  </div>
                </div>
                <div>
                  <div className="flex ml-6">
                    <div onClick={abrirPublicacion} className="relative group rounded-lg mt-14">
                      <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/80jvpSv/Rectangle-16.png" className="w-20 h-20" alt="man" />
                      {instagram}
                    </div>
                    <div onClick={abrirPublicacion} className="relative group rounded-lg mb-10 ml-6">
                      <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/6PR2Y74/Rectangle-15.png" className="w-20 h-24" alt="woman" />
                      {instagram}
                    </div>
                  </div>
                  <div onClick={abrirPublicacion} className="relative group rounded-lg sm:ml-6 mt-6 ml-48">
                    <img tabIndex={0} onClick={abrirPublicacion} src="https://i.ibb.co/M5rvjhk/Rectangle-14.png" alt="boy with blonde hair" className="w-48 h-32" />
                    {instagram}
                  </div>
                </div>
              </div>
              <div className="mt-6 flex">
                <div onClick={abrirPublicacion} className="relative group rounded-lg mb-8">
                  <img tabIndex={0} onClick={abrirPublicacion} className="w-48 h-48" src="https://i.ibb.co/GPpMsbr/Rectangle-12.png" alt="young girl with red hair" />
                  {instagram}
                </div>
                <div onClick={abrirPublicacion} className="relative group rounded-lg ml-6">
                  <img tabIndex={0} onClick={abrirPublicacion} className="w-72 h-56" src="https://i.ibb.co/VBcgkVL/Rectangle-11.png" alt="young girl with red hair" />
                  {instagram}
                </div>
              </div>
            </div>
        ...
        <div className="bg-white">
          <div className="container mx-auto flex flex-wrap items-center justify-center py-2">
              ...
              <div className="w-full sm:w-1/2 p-6">
                <svg className="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path transform="translate(-11.5 -150.75)"
                    ...
                    stroke="#f2f2f2" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                  <path transform="translate(-11.5 -150.75)"
              ...
              <div className="w-full sm:w-1/2 p-6 mt-6">
                <svg className="w-5/6 sm:h-64 mx-auto" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path transform="translate(-11.697 -13.011)"
                    ...
                    fill="none" opacity=".8" stroke="#ff6347" strokeMiterlimit="10" strokeWidth="2" />
                  <path transform="translate(-11.697 -13.011)"
